...
const EDITABLE_FIELDS = [
  { key: "hzzo_brand_name", label: "Naziv (HZZO brand)", type: "text" },
  { key: "inn", label: "INN", type: "text" },
  { key: "manufacturer_name", label: "Proizvođač", type: "text" },
  { key: "mah_name", label: "Nositelj odobrenja (MAH)", type: "text" },
  { key: "form_strength_pack", label: "Oblik / jačina / pakiranje", type: "text" },
  ...
  { key: "country", label: "Zemlja", type: "text" },
  { key: "prescription_status", label: "Režim izdavanja", type: "text" },
...
function useUpdateCatalogRow() {
  ...
  return useMutation({
    ...
    onError: (e: unknown) => {
      toast.error(`Neuspješno spremanje: ${(e as Error).message}`);
    },
  });
}
    ...
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2">
        <div className="relative min-w-[240px] flex-1 max-w-sm">
          ...
          <Input
            ...
            placeholder="Naziv, INN, kod ili EAN..."
        ...
        <Select value={promoted} onValueChange={(v) => setPromoted(v as PromotedFilter)}>
          ...
          <SelectContent>
            <SelectItem value="ALL">Svi zapisi</SelectItem>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="w-[70px]">Zemlja</TableHead>
      ...
      <div className="flex items-center justify-between">
        <p className="text-xs text-muted-foreground">
          ...
          {isFetching && !isLoading ? " · osvježavanje…" : ""}
        </p>
